...
class AuthController extends Controller
{
    ...
    */
	...
	protected $redirectAfterLogout = 'marketplace/';
    ...
    public function postLogin(Request $request) {
		...
		if (Auth::attempt(array($field => $request->email, 'password' => $request->password), true)) {
        //if (Auth::attempt(['email' => $request->email, 'password' => $request->password])) {
			if (Auth::attempt(array($field => $request->email, 'password' => $request->password, 'active' => 1), true)) {	
