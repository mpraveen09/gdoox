               ...
               // Getting the inserted variables in array from the Email Content
                ...
                if($request['status']==='draft'){
                    ...
                    if($data->save()) {
                        ...
                        $data->type = 'mail';
                        $final_val = array();
                        $final_val['template']= $request['content'];
                        
                        if($data->save()){
                            if(!empty($bcc) && !empty($cc)){
                                Mail::send('emails.crm_mail_template', $final_val, function($message) use ($to,$cc,$bcc){
                                    $message->from(Auth::user()->email, Auth::user()->username);
                                    $message->bcc($bcc);
                                    $message->cc($cc);
                                    $message->to($to)->subject('Gdoox CRM');
                                });
                            }
                            elseif(!empty($cc) && empty($bcc)){
                                Mail::send('emails.crm_mail_template', $final_val, function($message) use ($to, $cc){
                                    $message->from(Auth::user()->email, Auth::user()->username);
                            ...
                            elseif(!empty($bcc) && empty($cc)){
                                 Mail::send('emails.crm_mail_template', $final_val, function($message) use ($to, $bcc){
                                    $message->from(Auth::user()->email, Auth::user()->username);
                                ...
                                Mail::send('emails.crm_mail_template', $final_val, function($message) use ($to){
                                    $message->from(Auth::user()->email, Auth::user()->username);
                                    $message->to($to)->subject('Gdoox CRM');
                                });
                            }
...
//                                }
//                                elseif(!empty($cc) && empty($bcc)){
//                                    Mail::raw($final_val, function($message) use ($data,$cc,$val){
//                                        $message->from(Auth::user()->email, Auth::user()->username);
//                                        $message->cc($cc,Auth::user()->username);
//                                        $message->to($val, $val)->subject('Gdoox CRM');
//                                     });
//                                }
//                                elseif(!empty($bcc) && empty($cc)){
//                                        Mail::raw($final_val, function($message) use ($data,$bcc, $val){
//                                        $message->from(Auth::user()->email, Auth::user()->username);
//                                        $message->bcc($bcc, Auth::user()->username);
//                                        $message->to($val, $val)->subject('Gdoox CRM');
//                                     });
//                                } 
//                                else {
//                                    Mail::raw($final_val, function($message) use ($data, $val){
//                                        $message->from(Auth::user()->email, Auth::user()->username);
//                                        $message->to($val, $val)->subject('Gdoox CRM');
//                                    });
//                                }
...
//                            if($data->save()) {
//                                if(!empty($bcc) && !empty($cc)){
//                                    Mail::raw($final_val, function($message) use ($data,$bcc, $cc, $val){
//                                        $message->from(Auth::user()->email, Auth::user()->username);
//                                        $message->bcc($bcc,Auth::user()->username);
//                                        $message->cc($cc,Auth::user()->username);
//                                        $message->to($val,$val)->subject('Gdoox CRM');
