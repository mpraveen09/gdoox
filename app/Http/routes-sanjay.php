...
Route::any('dashboard/payment-methods/payment-info/create', array('as' => 'payment-info-create', 'uses' => 'backend\dashboard\PaymentMethodsController@paymentInfo'));
Route::any('dashboard/payment-methods/payment-method-info/store', array('as' => 'payment-info-store', 'uses' => 'backend\dashboard\PaymentMethodsController@storePaymentMethodInfo'));
/* -------------------------------------------@Usersbackend -------------------------------------------------------------------------- */
...
Route::any('dashboard/web-application/language', array('as' => 'web-app-lang', 'uses' => 'backend\dashboard\WebApplicationLangController@setLanguage'));