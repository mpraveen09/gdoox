...
@section('right_col')
  ...
  <h3 class="page-header"> View Private Investor</h3>
  
    <?php echo HTML::link("private-investor/edit/$view[_id]", "Edit");?>  |

    <?php echo HTML::link("private-investor/delete/$view[_id]", "Delete", array( "onclick"=>"return confirm('Are you sure you want to delete?')"))?>
