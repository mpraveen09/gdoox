...
if($UGML_Settings['UGML_Grid_Layout']) {
	...
	$UGML_menuType					= $UGML_Settings['UGML_menuType'];
	$UGML_multi_Cat_Sel				= $UGML_Settings['UGML_multi_Cat_Sel'];
	...
	$UGML_posterThumbnail			= $UGML_Settings['UGML_posterThumbnail'];
	$UGML_Custom_CSS				= $UGML_Settings['UGML_Custom_CSS'];
	if($UGML_spaceBwThumbnails == "")
	{
		$UGML_spaceBwThumbnails=10;
	}
}
else{
    	...
    	<div class="smart-forms smart-container wrap-1">
            ...
            <form method="post" action="" id="form-ui">
            	<div class="form-body">
                    ...
                    <div class="frm-row dementationOption"> <!-- "maxWidth" -->
                            ...
                            <label class="field select">
                                <select name="UGML_Font_Style" id="UGML_Font_Style">
                                    <optgroup label="Default Fonts">
										...
										<option value="grande" <?php selected($UGML_Font_Style, 'Grande' ); ?>>Grande</option>
										<option value="_helvetica_neue" <?php selected($UGML_Font_Style, '_helvetica_neue' ); ?>> <?php _e('Georgia','UGML_TEXT_DOMAIN'); ?> Helvetica Neue</option>
                    ...
                    <div class="frm-row"> <!-- Image Hover Color Opacity -->
                    ...
                    <div class="frm-row disableThumbnails"><!-- Disable Thumbnail -->
                    	<label class="field-label colm colm4 align-left"><?php _e('Disable Hover Effect','UGML_TEXT_DOMAIN'); ?>:</label>
						<div class="section colm colm6">
							<div class="option-group field">
								<label class="option">
									<input type="radio" name="UGML_disableThumbnails" id="UGML_disableThumbnails" value="yes" <?php if($UGML_disableThumbnails == 'yes' ) { echo "checked"; } ?> >
									<span class="radio"></span> <?php _e('Yes','UGML_TEXT_DOMAIN'); ?>
								</label>
								<label class="option">
									<input type="radio" name="UGML_disableThumbnails" id="UGML_disableThumbnails" value="no" <?php if($UGML_disableThumbnails == 'no' ) { echo "checked"; } ?>>
					...
					<div class="frm-row"><!-- Use Icon Button -->
					 ...
					 </div><!-- End of 'Number of Icons' Section -->
					 
					<div class="frm-row"><!-- Icon Style -->
                    ...
                    <div class="frm-row showMenu"><!-- Menu Background Color -->
					 ...
					 </div> <!-- End of 'Background Color' Section -->
