...
?>
    <section class="content_section page_title">
        <div class="content clearfix">
            <h1 class="">
                <?php if (is_day()):
                    printf(__('Archives: %s', 'kyma'), '<span>' . get_the_date() . '</span>');
                elseif (is_month()) :
                    printf(__('Archives: %s', 'kyma'), '<span>' . get_the_date(_x('F Y', 'monthly archives date format', 'kyma')) . '</span>');
                elseif (is_year()) :
                    printf(__('Archives: %s', 'kyma'), '<span>' . get_the_date(_x('Y', 'yearly archives date format', 'kyma')) . '</span>');
                else :
                    _e('Archives', 'kyma');
                endif; ?>
            </h1>
            ...
            <div class="content_spacer clearfix"><?php
                ...
                <div class="content_block col-md-9 <?php echo esc_attr($float); ?> "><?php
                    ...
                    <div class="hm_blog_list clearfix"><?php
                        ...
                        $args = array('post_type' => 'gdoox_university', 'paged' => $paged);
