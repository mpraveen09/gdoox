...
<!--                        <span><i class="fa fa-phone"></i><span
                    ...
                    if ($kyma_theme_options['contact_email']) {
                        ...
                        <span><i class="fa fa-envelope-o"></i><span
							...
							<a href="mailto:<?php echo sanitize_email('join@gdoox.com'); ?>"><?php echo sanitize_email('join@gdoox.com'); ?></a></span>
                    <?php } ?>
                </div>
                <?php } if ($kyma_theme_options['social_media_header']) { ?>
                    <div class="top-socials box_socials f_right">
                  <?php pll_the_languages(array('dropdown'=>1, 'show_flags'=>1, 'show_names'=>0, 'hide_current'=>1)); ?>                 
                  <!--
