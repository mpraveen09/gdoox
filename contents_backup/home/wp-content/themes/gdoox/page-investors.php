    ...
    <div class="content">
      <div class="internal_post_con clearfix">
        ...
        <div class="content_block col-md-12">
          ...
          <?php if( !empty( get('individual_investor_form') ) ){ ?>
            <div class="col-md-5 col-sm-5">
              <h3 class="feature-title">
                <?php if( !empty( get('individual_investor_title') ) ){ 
                  echo get('individual_investor_title');
                }else{
                  echo "Individual investor";
                }?>
              </h3>
              <div>
                <?php //var_dump( get_post_meta(get('individual_investor_form')) ) ;
                  $frm_id = get('individual_investor_form');
          ...
          <?php if( !empty( get('organization_form') ) ){ ?>
            <div class="col-md-5 col-sm-offset-2 col-sm-5">
              <h3 class="feature-title">
                <?php if( !empty( get('organization_title') ) ){ 
                  echo get('organization_title');
                }else{
                  echo "Organization";
                }?>
              </h3>
