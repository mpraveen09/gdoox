...
<?php get_template_part('breadcrumbs'); ?>
    <!-- End Page Title -->
    <!-- Our Blog Grids -->
    <section class="content_section feature-single">
    <div class="content">
...
<!--            <div class="post_title_con">
            ...
            <div class="post_next_prev_con clearfix">
                ...
                <div class="post_next_prev clearfix">
                    <?php next_post_link('%link', '<i class="fa fa-long-arrow-left"></i><span class="t">' . __('Previous', 'kyma') . '</span>'); ?>
