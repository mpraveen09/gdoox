            ...
            {!! Form::open([
              ...
              @if (!empty($fm_data->labels))
                <div class="form-group clearfix">
                      ...
                      @if (!empty($fm_data->labels['facebook']))
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('facebook','', array('placeholder' =>$fm_data->labels['facebook'],'class'=>'form-control')) !!}
                          </div>    
                      @endif
                </div>
                ...
                <div class="form-group clearfix">
                     ...
                     @if (!empty($fm_data->labels['linkedin']))
                         <div class="col-md-6 col-sm-6 col-xs-12">
                         {!! Form::text('linkedin','', array('placeholder' =>$fm_data->labels['linkedin'],'class'=>'form-control')) !!}
                         </div>    
                     @endif
                 </div>
                 ...
                 <div class="form-group clearfix">
                      @if(!empty($fm_data->labels['twitter']))
                           {!! Form::label('twitter','', array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')) !!} 
                      @endif

                      @if (!empty($fm_data->labels['twitter']))
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('twitter','', array('placeholder' =>$fm_data->labels['twitter'],'class'=>'form-control')) !!}
                          </div>    
                      @endif
                  </div>
                 ...
                 <div class="form-group clearfix">
                      ...
                      @if (!empty($fm_data->labels['pinterest']))
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('pinterest','', array('placeholder' =>$fm_data->labels['pinterest'],'class'=>'form-control')) !!}
                          </div>    
                      @endif
                  </div>
                 ...
                 <div class="form-group clearfix">
                      @if(!empty($fm_data->labels['google']))
                           {!! Form::label('google','', array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')) !!} 
                      @endif

                      @if (!empty($fm_data->labels['google']))
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('google','', array('placeholder' =>$fm_data->labels['google'],'class'=>'form-control')) !!}
                          </div>    
                      @endif
                  </div>
