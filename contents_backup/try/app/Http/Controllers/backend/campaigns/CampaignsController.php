    ...
    public function create(){
        try {
            if(Auth::user()) {
                ...
                return view('backend.campaigns.create', compact('fm_data','campaigntype','campaigns','campaign_requests'));
            }
            else {
    ...
    public function edit($id){
        try {
            if(Auth::user()){
                ...
                return view('backend.campaigns.edit', compact('fm_data','campaigntype','campaign','id'));
            }
            else {
               return redirect('auth/login')->with('message',"Please Login to Create Task!"); 
            }
    ...
    public function campaignRequest(Request $request){
        try {
            if(Auth::user()){
                ...
                return view('backend.campaigns.create_campaign', compact('fm_data','campaigntype','campaigns'));
            }
            else {
               return redirect('auth/login')->with('message',"Please Login to Create Task!"); 
            }
    ...
    public function editCampaignRequest($id){
        try {
            if(Auth::user()){
                ...
                $fm_data = FieldMaster::where('title','campaigns')->where('lang', $this->language)->first();
                return view('backend.campaigns.edit_campaign', compact('fm_data','campaigntype','campaign','id'));
            }
            else {
               return redirect('auth/login')->with('message',"Please Login to Create Task!"); 
            }
