...
//        echo $confirm; die;
        ...
        return view('backend.dashboard.category_uploads.create',compact('fm_data', 'term', 'tmp_categories', 'col', 'filename'));
        }
      catch (Exception $ex) {
          $error = "An error occured. ".
                          "Line Number: ".$e->getLine()." ".
 ...
 //end final categories       
   ...
   //view Import categories
        ...
        $term = 3;
        $filename = $name;
        return view('backend.dashboard.category_uploads.create',compact('fm_data', 'term', 'categories', 'cat_attribute', 'name', 'filename', 'col'));
      }
      catch (\Exception $e){
          $error = "An error occured. ".
                          "Line Number: ".$e->getLine()." ".
