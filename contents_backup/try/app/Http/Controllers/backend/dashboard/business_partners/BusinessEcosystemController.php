        ...
        if(Auth::user()) {
          try{
            ...
            if($invited_users->count()){
                ...
                return view('backend.dashboard.shared_users.invited_users',compact('fm_data','invited_user_name'));
            }
            else {
                    $invited_user_name='';
    ...
    public function listProducts(){
        if(Auth::user()){
          try{
            ...
            return view('backend.dashboard.shared_users.list_products',compact('fm_data','list_products','userid','store_id','invited_user_id','shared_status'));
          }
          catch (\Exception $e){
              $error = "An error occured. ".
                              "Line Number: ".$e->getLine()." ".
