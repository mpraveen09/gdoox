...
class FollowersController extends Controller
{
  use \Gdoox\Helpers\backend\dashboard\HelperFunctions;
        ...
        if(Auth::user()){
          try {
                ...
                if($follower_data->save()){
                    return view('backend.dashboard.business_partners.business_followers.index',compact('follower_data'));
                }
          }
          catch (\Exception $e){
    ...
    {
         return view('backend.dashboard.business_partners.business_followers.edit',compact('shop_id'));
    }
}
