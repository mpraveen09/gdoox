...
class ImportEcomProductsController extends Controller
{
    ...
    public function viewProducts(){
        if(Auth::user()){  
            ...
            return view('backend.dashboard.business_partners.import_products.view_ecom_products',compact('list_products','site','fm_data','ecosystemsite'));
        }
        else {
...
//    }
    ...
    public function viewMyProducts($ecom_slug="", $site=""){
        if(Auth::user()){
            ...
            $list_products = Products::whereNotIn('_id', $imported)->where('shopid', $site)->where('status','enabled')->where('product_type','!=','shared')->paginate(25);
