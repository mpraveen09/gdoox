     ...
     public function joinRequest($shopid){
       if(Auth::user()){
         try{
          ...
          return view('backend.dashboard.business_partners.internal_partners.joinrequest',compact('shopid','user_id','owner_id','user_email','owner_email'));
         }
          catch (\Exception $e){
              $error = "An error occured. ".
                        "Line Number: ".$e->getLine()." ".
     ...
     public function partnerRequest($shopid){
       if(Auth::user()){
         try{
            ...
            return view('backend.dashboard.business_partners.internal_partners.partner_request',compact('shopid','data'));
         }
          catch (\Exception $e){
              $error = "An error occured. ".
                              "Line Number: ".$e->getLine()." ".
