...
class JobDetailsController extends Controller
{
    ...
    public function create(){
        try {
           ...
           return view('backend.dashboard.personal_sites.job_details.create',compact('fm_data','required','jobdetails','position', 'organization','org_cat'));
        }
        catch (\Exception $e){
    ...
    public function edit($id){
      try{
            ...
            return view('backend.dashboard.personal_sites.job_details.edit',compact('fm_data','required','jobdetails','position','organization','org_cat','orgtype'));
      }
      catch (\Exception $e){
          $error = "An error occured. ".
            "Line Number: ".$e->getLine()." ".
