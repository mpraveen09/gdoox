...
class UserReferencesController  extends Controller
{
    ...
    public function create()
    {
        if(Auth::user())
        {
          try{
            ...
            {
                return view('backend.dashboard.personal_sites.user_references.create',compact('fm_data'));
            }
          }
          catch (\Exception $e){
    ...
    public function edit($userid)
    {
      try{
        ...
        return view('backend.dashboard.personal_sites.user_references.edit',compact('fm_data','info','competency'))->with('userid',$userid);
      }
      catch (\Exception $e){
          $error = "An error occured. ".
                          "Line Number: ".$e->getLine()." ".
