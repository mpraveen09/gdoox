                  ...
                  <div class="table-responsive" tabindex="1" style="overflow: hidden; outline: none;">
                      @if($biddings->count())
                              ...
                              <tbody>
                                  @foreach ($biddings as $bidding)
                                       <tr>
                                           ...
                                           <td>
                                               @if(!empty($bidding->highest_bid_username))
                                                   {!! $bidding->highest_bid_username !!}
                                               @else
                                                    {!! 'N/A' !!}
                                               @endif
                                           </td>
                                           ...
                                           <td>@if(date("Y-m-d") > $bidding->end_date) <span style="color: #ff0000;">Completed</span> @else <span style="color: #008000;">Active</span>  @endif</td>
                                           <td>
                       ...
                       @else 
                          <div class="card-body card-padding">
                              <div class="table-responsive" tabindex="1" style="overflow: hidden; outline: none;">
                                   You have No products in Auction.
                              </div>
                           </div> 
                       @endif
                  </div>
