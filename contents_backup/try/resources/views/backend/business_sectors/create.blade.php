...
<!--                                 <button id="search_category" name="search_category" class="btn btn-default btn-icon-text waves-effect">Go!</button>-->
                    ...
                    <div class="div_wait row prod_cats">
                        <div class="col-md-12">
                            <b>Please select the Product Categories to Add Business Sectors</b>
                        </div>
                    </div>
            
                    <div style="background-color: #009900; display: none" class="div_proceed row prod_cats">
                        <div class="col-md-12">
                            <b>You can click Add to add the category to your business sector.</b>
                        </div>
                    </div>
                
                    {!! Form::open(['action'=>'backend\business_sectors\BusinessSectorsController@store', 'class' => 'form-horizontal form-label-left', 'novalidate'=>'']) !!}
                        <div class="row">
                             <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <button id="send_prod_cat" type="submit" class="btn btn-round btn-success">Save</button>       
                        </div>
                    {!! Form::close() !!}  
                    <div class="row">
                        <div class="col-md-4">
