...
@endif
    ...
    <div class="card">
        ...
        @endif
        {!! Form::open(array('route' => 'interest-info-update','method'=>'PUT', 'class'=>'form-horizontal form-label-left', Auth::user()->id)) !!}
              ...
              @if (!empty($fm_data->labels))
                 <div class="form-group clearfix">
                      @if(!empty($fm_data->labels['sport']))
                          ...
                          {!! Form::text('sport', $interest_info->sport, array('placeholder' =>$fm_data->labels['sport'],'class'=>'form-control')) !!}
                          </div>    
                      @endif
                  </div>
                 ...
                 <div class="form-group clearfix">
                      @if(!empty($fm_data->labels['books']))
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('books', $interest_info->books, array('placeholder' =>$fm_data->labels['books'],'class'=>'form-control')) !!}
                          </div>    
                      @endif
                  </div>
                 ...
                 <div class="form-group clearfix">
                      @if(!empty($fm_data->labels['music']))
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('music', $interest_info->music, array('placeholder' =>$fm_data->labels['music'],'class'=>'form-control')) !!}
                          </div>    
                      @endif
                  </div>
                 ...
                 <div class="form-group clearfix">
                      @if(!empty($fm_data->labels['games_music']))
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('games_music', $interest_info->games_music, array('placeholder' =>$fm_data->labels['games_music'],'class'=>'form-control')) !!}
                          </div>    
                      @endif
                  </div>
