...
<?php echo Form::open(array('action'=>'InvestorsController@UpdatePrivateInvestor'));?>
 <?php   echo Form::hidden('private_id',$private_data[0]['_id']);?>
   <h3 class="page-header">Edit Private Investor</h3>
   <div class=" col-md-12 ">
     
 <?php
 //print_r($private_data); die;
//@--------------------------------Checks Message is exist--------------------------------
    ...
    echo Form::text("edit_txt", $private_data[0]['edit_txt'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
...
//@--------------------------------Checks First Name is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("fst_name", $private_data[0]['fst_name'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
 ...
 //@--------------------------------Checks Last Name is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("lst_name", $private_data[0]['lst_name'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
 ...
 //@--------------------------------Checks Last Name is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("scnd_name", $private_data[0]['scnd_name'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
...
//@--------------------------------Checks Initials is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("initials", $private_data[0]['initials'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
...
//@--------------------------------Checks Street address of business is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("strt_add_of_bsns", $private_data[0]['strt_add_of_bsns'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
 ...
 //@--------------------------------Checks if key "city" is exist--------------------------------
     ...
     echo "<div class='col-md-8'>";
     echo Form::text("city_of_bsns", $private_data[0]['city_of_bsns'], array("required","class"=>"form-control"));
     echo "</div>";
     echo "</div>";
...
//@--------------------------------Checks if key "cntry_of_busns" is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::select("country_of_bsns",$field_master_data[0]['country_of_bsns']['option'], $private_data[0]['country_of_bsns'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
...
//@--------------------------------Checks if key "zip" is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("zip", $private_data[0]['zip'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
  ...
  //@--------------------------------Checks if key "ph_no1" is exist--------------------------------
     ...
     echo "<div class='col-md-8'>";
     echo Form::text("ph_no1", $private_data[0]['ph_no1'], array("class"=>"form-control"));
     echo "</div>";
     echo "</div>";
...
//@--------------------------------Checks if key "ph_no2" is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("ph_no2", $private_data[0]['ph_no2'], array("class"=>"form-control"));
    echo "</div>";
    echo "</div>";
...
//@--------------------------------Checks if key "fax_no" is exist--------------------------------
     ...
     echo "<div class='col-md-8'>";
     echo Form::text("fax_no", $private_data[0]['fax_no'], array("class"=>"form-control"));
     echo "</div>";
     echo "</div>";
...
//@--------------------------------Checks if key "mob" is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("mob", $private_data[0]['mob'], array("required","class"=>"form-control"));
    echo "</div>";
    echo "</div>";
    ...
    //@--------------------------------Checks if key "msm" is exist--------------------------------
     ...
     echo "<div class='col-md-8'>";
     echo Form::text("msm", $private_data[0]['msm'], array("required","class"=>"form-control"));
     echo "</div>";
     echo "</div>";
...
//@--------------------------------Checks if key "skype" is exist--------------------------------
    ...
    echo "<div class='col-md-8'>";
    echo Form::text("skype", $private_data[0]['skype'], array("class"=>"form-control"));
    echo "</div>";
    echo "</div>";
...
//@--------------------------------Checks if key "bsns_email" is exist--------------------------------
     ...
     echo "<div class='col-md-8'>";
     echo Form::text("bsns_email", $private_data[0]['bsns_email'], array("class"=>"form-control"));
     echo "</div>";
     echo "</div>";
...
//         $checkbox_org.="<label>";
//         $checkbox_org.= Form::checkbox("avail_docs[]",$check_key,  in_array($check_key,$private_data[0]['avail_docs']  ));
