            ...
            if(Auth::user()){
                ...
                if(!empty($check)){
                   return Redirect::route('personal-about-us-edit',$userid);
                    ...
                    return view('backend.dashboard.about_us.create',compact('fm_data','nav_menu','route'));
                }
            }
            else {
    ...
    public function edit($userid){
        try{
            if(Auth::user()){
                ...
                return view('backend.dashboard.about_us.edit',compact('fm_data','info','nav_menu','route'))->with('userid',$userid);
            }
            else{
              return redirect('auth/login')->with('message',"Please Login to Add Information!"); 
            }
