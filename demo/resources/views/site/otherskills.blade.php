        ...
        <div class="col-md-12">
          <div class="card">
              <div class="card-header card-padding-sm bgm-blue">
                  <h2>{!! $fm_data->labels['other_skills'] !!}</h2>
              </div>
                     ...
                     <table class="table table-striped responsive-utilities jambo_table ">
                          <tbody>
                            @if($sitetype==='personal')
                                @if($storename->other_info['other_skills'])
                                 <tr>
                                     <td class="col-md-4">{!!$fm_data->labels['other_skills']!!}</td>
                                     <td>{!! $storename->other_info['other_skills'] !!}</td>
                                 </tr>
                                 @else
                                 <tr>There are no other Skills</tr>
                                @endif
                            @endif
                           </tbody>
                     </table>
