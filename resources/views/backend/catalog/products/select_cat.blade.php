...
<script>
    ...
    //$(document).on("click","#search_category",function(e) {
            ...
            $('.prod_cat_sub_div').html("");    //Code Added by praveen to rectify search result
             $('.prod_cat_sub_head').html("");  //Code Added by praveen to rectify search result
            e.preventDefault();
            var term = $('#term').val();
           
//            if(trim(term) == ""){
//               term = $(".prod_cat_root li.active").html();
//            }console.log(term);
            $.ajax({
...
//            console.log(offset.top);
            ...
            //$('input#term').val(); initially this code is here. Praveen Cahnges term value to blank("").
