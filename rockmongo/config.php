...
$MONGO["servers"][$i]["mongo_user"] = "deep";//mongo authentication user name, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_pass"] = "qwaszxXZSAWQ@321!";//mongo authentication password, works only if mongo_auth=false
...
$MONGO["servers"][$i]["control_users"]["deep"] = "qwaszxXZSAWQ@321!";//one of control users [USERNAME]=PASSWORD, works only if mongo_auth=false
