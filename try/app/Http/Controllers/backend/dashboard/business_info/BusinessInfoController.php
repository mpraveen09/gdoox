    ...
    public function create(){
      try {
            ...
            if(count($company) < 1 ){
              ...
              $company_dims=  DropdownOption::where('name','company_dimension')->where('lang', 'en')->first();
              ...
              $business_opts=  DropdownOption::where('name','business_operation')->where('lang','en')->first();
              foreach($business_opts->options as $business_optname)
              {
                $business_opt[$business_optname]=$business_optname;
              }

              $accept_payments=  DropdownOption::where('name','payment_accepted')->where('lang','en')->first();
              ...
              $credit_cards= DropdownOption::where('name','credit_card')->where('lang','en')->first();
