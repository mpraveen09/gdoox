...
class JobDetailsController extends Controller {
    ...
    public function create(){
        try {
                ...
                $positions = DropdownOption::where('name','position')->where('lang', 'en')->first(); 
                ...
                $organizations = DropdownOption::where('name','organization_type')->where('parent','')->where('lang','en')->first(); 
    ...
    public function edit($id){
      try{
            ...
            $orgcat = DropdownOption::where('parent',$jobdetails->job_details[0]['org_type'])->where('lang','en')->first();
            ...
            $organizations = DropdownOption::where('name','organization_type')->where('lang','en')->first();
            foreach($organizations->options as $organizationname){
                $organization[$organizationname] = $organizationname;
            }
    ...
    public function getOrganizationCategory(Request $request){
        if(Auth::user()){
            ...
            $organizations = DropdownOption::where('parent',$data['org_type'])->where('lang','en')->first();
