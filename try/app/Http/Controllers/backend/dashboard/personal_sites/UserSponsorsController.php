...
class UserSponsorsController  extends Controller {
            ...
            if(Auth::user()){
                ...
                if(!empty($check)){
                   return Redirect::route('sponsors-edit',$userid);
                    ...
                    return view('backend.dashboard.personal_sites.user_sponsors.create',compact('fm_data','nav_menu','route'));
                }
            }
            else {
    ...
    public function edit($userid)
    {
      try{
        ...
        return view('backend.dashboard.personal_sites.user_sponsors.edit',compact('fm_data','info','nav_menu','route'))->with('userid',$userid);
      }
      catch (\Exception $e){
          $error = "An error occured. ".
                          "Line Number: ".$e->getLine()." ".
