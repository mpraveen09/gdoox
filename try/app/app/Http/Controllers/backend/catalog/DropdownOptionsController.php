...
class DropdownOptionsController extends Controller {
    ...
    public function index(){
      try {
            ...
            $dropdownoptions = DropdownOptions::where('lang', '=', 'en')->get();
  ...
  //            return Redirect::to('backend/catalog/dropdownoptions/');
    ...
    public function show($id){
      try{
            ...
            $dropdownoptions= DropdownOptions::where('name', '=', $id)->where('lang', '=', 'en')->first();
    ...
    public function edit($id){
      try{
            ...
            $dropdownoptions= DropdownOptions::where('_id', '=', $id)->where('lang', '=', 'en')->first();
