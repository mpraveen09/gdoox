    ...
    public function changeProductVisibility($id){
        ...
        if($_GET['status'] ==='enabled'){
            if($product->purpose === 'sell'){
                ...
                else if(empty($product->product_data[16]) && empty($product->product_data[18]) && empty($product->product_data[20]) && empty($product->product_data[21])){
                     $status = 'price_error';
                }
                else {
                ...
                else if(empty($product->product_data[22])){
                     $status = 'price_error';
                }
                else {
                    DB::collection('products')->where('_id', $id)->update(['status'=>$_GET['status'], 'disable_edit'=>'Yes']);
