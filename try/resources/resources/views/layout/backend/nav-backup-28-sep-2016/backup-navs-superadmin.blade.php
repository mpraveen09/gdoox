...
<!--    <li><a href="{!! route('position.create')!!}">YOUR POSITION IN THE COMPANY</a></li>-->
...
<!------------------------------------------------------Campaigns-------------------------------------------------------------------->
<li class="sub-menu">
  <a href=""><i class="zmdi zmdi-view-list"></i>Campaigns</a>
  <ul>
...
<!------------------------------------------------------Manage Users-------------------------------------------------------------------->
<!--<li class="sub-menu">
  <a href=""><i class="zmdi zmdi-view-list"></i>Permissions</a>
  <ul>
        <li><a href="{!! route('colleague.all')!!}">Manage Permissions</a></li>
  </ul>           
</li> -->
<!-------------------------------------------End Manage Users------------------------------------------------------------------------->
