              ...
              @if (!empty($fm_data->labels)
                <div class="form-group clearfix">
                    @if(!empty($fm_data->labels['relation']))
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::select('relation[]', $relation, '', array('id'=>'relation','multiple', 'required', 'class'=>'form-control')) !!}
                        </div>    
                    @endif
                </div>
                ...
                <div class="form-group clearfix">
                    @if(!empty($fm_data->labels['relation_code']))
                         ...
                         <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('relation_code', '', array('id'=>'relation_code','required','placeholder' =>$fm_data->labels['relation_code'],'class'=>'form-control')) !!}
                        </div>    
                    @endif
                </div>
